...
```gradle
dependencies {
    implementation 'com.github.apiverve:dadjokes-api:1.1.13'
}
```
...
```java
import com.apiverve.dadjokes.DadJokesAPIClient;
import com.apiverve.dadjokes.APIResponse;
import com.apiverve.dadjokes.APIException;

// Initialize the client
DadJokesAPIClient client = new DadJokesAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/dadjokes](https://docs.apiverve.com/ref/dadjokes)
...
- **Documentation:** [https://docs.apiverve.com/ref/dadjokes](https://docs.apiverve.com/ref/dadjokes)
- **Issues:** [GitHub Issues](https://github.com/apiverve/dadjokes-api/issues)
