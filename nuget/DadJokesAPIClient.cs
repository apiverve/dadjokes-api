...
namespace APIVerve.API.DadJokes
{
    /// <summary>
    ...
    /// <summary>
    /// Client for the DadJokes API
    /// </summary>
    public class DadJokesAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/dadjokes";
        ...
        public DadJokesAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public DadJokesAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public DadJokesAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, DadJokesQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(DadJokesQueryOptions options)
        {
        ...
        public ResponseObj Execute(DadJokesQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(DadJokesQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(DadJokesQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(DadJokesQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(DadJokesQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(DadJokesQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(DadJokesQueryOptions options)
        {
