...
namespace APIVerve.Examples
{
    class DadJokesExample
    {
        ...
        {
            Console.WriteLine("📤 Calling Dad Jokes API...\n");

            var result = await CallDadJokesAPI();
