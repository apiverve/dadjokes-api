 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/dadjokes?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/dadjokes';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\DadjokesClient] {$message}\n";
        }
    }
}
