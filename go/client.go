// Package dadjokes provides a Go client for the Dad Jokes API.
//
// For more information, visit: https://apiverve.com/marketplace/dadjokes?utm_source=go&utm_medium=readme
package dadjokes
...
const (
	baseURL        = "https://api.apiverve.com/v1/dadjokes"
	defaultTimeout = 30 * time.Second
)

// Client is the Dad Jokes API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Dad Jokes API client.
...
// Execute makes a request to the Dad Jokes API.
